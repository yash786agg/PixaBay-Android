...
import com.app.androidPixabay.commons.util.ConstantTest.Companion.HITSCOMMENT
import com.app.androidPixabay.commons.util.ConstantTest.Companion.HITSLIKES
import com.app.androidPixabay.commons.util.ConstantTest.Companion.HITS_ID
import com.app.androidPixabay.commons.util.ConstantTest.Companion.HITS_TAG
import com.app.androidPixabay.commons.util.ConstantTest.Companion.HITS_USER
import com.app.androidPixabay.commons.util.ConstantTest.Companion.PREVIEW_URL
import com.app.androidPixabay.commons.util.SequenceList
import com.app.androidPixabay.domain.entities.HitsListGenerator.getEmptyHitsListData
import com.app.androidPixabay.domain.entities.HitsListGenerator.getSuccessHitsListData
